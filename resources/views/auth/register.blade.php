                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('slug') ? ' has-error' : '' }}">
                            <label for="slug" class="col-md-4 control-label">UserName</label>
                        ...
                        <div class="form-group">
                            <label for="annee_scolaire_id" class="col-md-4 control-label">Annee Scolaire</label>

                            <div class="col-md-6">
                                <span>{{$annee_scolaire->designation}}</span>
                                <input id="annee_scolaire_id" type="hidden" class="form-control" name="annee_scolaire_id" value="{{$annee_scolaire->designation}}">
                            </div>
                        </div>
