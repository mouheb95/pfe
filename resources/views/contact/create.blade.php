            ...
            <section class="container">
                <div class="row">
                    <div class="ct-form-section ct-form-section--type2">
                        ...
                        <form action="{{route('contact.store')}}" method="POST" class="ct-js-validate ct-form-section__form"><span class="ct-form-section__header">We promise to get back to you within 48h.</span>
                            <div class="row">
                                {{csrf_field()}}
                                <div class="col-sm-6">
