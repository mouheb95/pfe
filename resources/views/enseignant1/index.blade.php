...
@section('container')
        <header data-parallax="50" class="ct-page-header ct-page-header--small">
            ...
            <div class="ct-page-header__inner">
                <div class="container">
                    <h1 class="h1 ct-page-header__title">afficher les <b>Enseignant</b></h1>
                </div>
            </div>
        </header>
        <!-- *** Main *** -->
                            ...
                            <div class="ct-testimonial">
                                <div class="ct-testimonial__inner">
                                    <div class="ct-testimonial__image">
                                        <a href="{{route('enseignant.show',$enseignant)}}"><img src="images/demo-content/team-02.jpg" alt="Carmen Mendez" /></a>
                                    </div>
                                    <h4 class="ct-testimonial__name">{{$enseignant->grade}}</h4>
