        ...
        <main>
            ...
            <section class="container">
                <div class="ct-slick ct-js-slick ct-slick--main ct-slick--arrows1">
                    ...
                    <div data-background="{{ URL::asset('images/demo-content/event-birthday3.jpg')}}" class="item">
                        <div class="ct-slick__footer">
                            <div class="inner">
                                <h3>{{$actualite->sujet}}</h3>
                                <div role="separator" class="divider"></div><span>{{$actualite->contenu}}</span>
                            </div>
                            <div class="inner"><a href="{{route('actualite.show',$actualite->id)}}" class="btn btn-default-o">Voir Actualite</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
