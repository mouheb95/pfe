                            ...
                            <div class="ct-testimonial">
                                <div class="ct-testimonial__inner">
                                    <div class="ct-testimonial__image">
                                        <a href="<?php echo e(route('tuteur.show',$tuteur)); ?>"><img src="images/demo-content/team-02.jpg" alt="Carmen Mendez" /></a>
                                    </div>
                                    <h4 class="ct-testimonial__name"><?php echo e($tuteur->etat_civil); ?></h4>
