...
<head>
    ...
    <script type="text/javascript" src="<?php echo e(URL::asset('js/CZ3CFmKcMfCcupa_86mxMcuVsN8.js')); ?>"></script>
    <!-- <link rel="shortcut icon" href="images/favicon.ico"> -->    
    <link rel="stylesheet" href="<?php echo e(URL::asset('images/favicon.ico')); ?>"> 
    <link rel="apple-touch-icon" href="<?php echo e(URL::asset('images/favicon.png')); ?>">
    <!-- <link rel="stylesheet" href="<?php echo e(URL::asset('images/favicon.png')); ?>">  -->
...
<body class="cssAnimate is-sidebar">
            ...
            <div class="midbar">
                <div class="midbar__inner">
                    <ul class="midbar-nav list-inline">                                               
                        ...
                        <!-- <li class="nav-item"><a href="<?php echo e(route('eleve.index')); ?>">Eleves</a>
                        </li> -->
                        <!-- <li class="nav-item"><a href="<?php echo e(route('enseignant.index')); ?>">Enseignant</a>
                        </li> -->

                         <?php if(Auth::user()!=null): ?>
                         <li class="nav-item"><a href="<?php echo e(route('user.show',Auth::user()->id)); ?>">My Profile</a>
                        </li>
                        <?php endif; ?>
            ...
            <div class="navbar navbar-default navbar-fixed">
                <div class="navbar-header">
                    <a href="<?php echo e(route('home.index')); ?>" class="navbar-brand">
                        <img src="<?php echo e(URL::asset('images/demo-content/logo.png')); ?>" alt="logo">
                    </a>
                </div>
                    <?php if(Auth::user()!=null): ?>
                    ...
                    <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>"  class="btn btn-motive pull-right">Login</a>
                    <?php endif; ?>

                <ul class="nav navbar-nav navbar-right">
                    <li class="nav-item"><a href="<?php echo e(route('home.index')); ?>">Home</a>
                    </li>                             
                    <li role="presentation" class="dropdown nav-item nav-item"><a href="<?php echo e(route('eleve.index')); ?>" class="dropdown-toggle">Eleves<span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a style="text-align: center;" href="<?php echo e(route('niveau.show',$niveau->id)); ?>"><?php echo e($niveau->designation); ?></a>
                            </li>
                    ...
                    <li class="nav-item"><a href="<?php echo e(route('club.index')); ?>">Clubs</a>
                    </li>
                    ...
                    <?php if(Auth::user() != null): ?>
                    <li role="presentation" class="dropdown nav-item nav-item" id="markasread" ><a href="#" class="dropdown-toggle" >Notification<span class="bagdet"><?php echo e(count(auth()->user()->unreadNotifications)); ?></span><span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li>
                                <li>
                                        ...
                                        <?php echo $__env->make('notification.'.snake_case(class_basename($notification->type)), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    ...
                    <li role="presentation" class="dropdown nav-item nav-item"><a href="#" class="dropdown-toggle"> A Effacer<span class="caret"></span></a>
                        <ul class="dropdown-menu">                          
                            ...
                            <li role="presentation" class="submenu"><a href="#" class="submenu-toggle">Admin Notification<i class="fa fa-caret-right"></i></a>
                                <ul class="dropdown-menu">
                                    <li><a href="<?php echo e(route('contact.index')); ?>">Messages Contact</a>
                                    </li>
                                    <li><a href="<?php echo e(route('enseignant.index')); ?>">Audio Post</a>
                                    </li>
                    ...
                    <li class="nav-item"><a href="<?php echo e(route('contact.create')); ?>">Contact Us</a>
                    </li>
                </ul>
            </div>
        </nav>
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="widget widget_flickr">
                            <div class="widget-inner">
                                ...
                                <script type="text/javascript" data-cfasync="false" src="<?php echo e(URL::asset('js/d07b1474/cloudflare-static/email-decode.min.js')); ?>"></script><script type="text/javascript" src="http://www.flickr.com/badge_code_v2.gne?count=9&amp;display=random&amp;size=s&amp;layout=x&amp;source=group&amp;group=1035848@N23"></script>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="ct-mobile-menu__inner">
            ...
            <div class="ct-mobile-menu__content">
                ...
                <ul class="ct-mobile-menu__list list-unstyled">
                    ...
                    <li class="nav-item"><a href="<?php echo e(route('enseignant.index')); ?>">Enseignants</a>
                    </li>
                    <li class="nav-item"><a href="<?php echo e(route('niveau.create')); ?>">classes</a>
                    </li>
                    <li class="nav-item"><a href="<?php echo e(route('groupe.create')); ?> ">Groupes</a>
                    </li>
    ...
    <!-- *** JavaScripts *** -->
    <!-- ******************* -->
    <script data-cfasync="false" src="js/email-decode.min.js"></script><script src="<?php echo e(URL::asset('js/confetti.min.js')); ?>"></script>
