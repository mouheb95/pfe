                    ...
                    <div class="col-md-9 ct-blog__content">
                        <article class="ct-blog-post ct-blog-post--image">
                            <div class="ct-blog-post__media">
                                <img src="<?php echo e(URL::asset('images/demo-content/blog-01.png')); ?>" alt="Cupcake Paper Flowers" />
                            </div>
                            <div class="ct-blog-post__body">
                                ...
                                <div class="ct-blog-post__description"> <span class="ct-blog-post__author"><?php echo e(Auth::user()->slug); ?></span>
                                    <?php if(Auth::user()->role_id == 3): ?>
                                    <a href="#" class="ct-blog-post__category"><span><?php echo e($enseignant->grade); ?></span></a>
                                    <?php endif; ?>
                            ...
                            <div class="ct-sidebar__inner">
                                ...
                                <div class="widget widget_archive">
                                    ...
                                    <div class="widget-inner">
                                        ...
                                        <ul>
                                                <?php $__currentLoopData = $groupes_enseignants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupes_enseignant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li><a href="<?php echo e(route('groupe.show',$groupes_enseignant->groupe_id)); ?>"><span class="pull-left"><?php echo e($groupes_enseignant->groupe->designation); ?></span><span class="pull-right">(16)</span></a>
                                                </li>
                                    ...
                                    <div class="widget-inner">
                                        ...
                                        <ul>
                                                ...
                                                <li><a href="<?php echo e(route('eleve.show',$eleve->id)); ?>"><span class="pull-left"><?php echo e($eleve->nom); ?></span><span class="pull-right"><?php echo e($eleve->groupe->designation); ?></span></a>
                                                </li>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php endif; ?>
                                        </ul>
                                            ...
                                            <li>
                                                <div class="widget widget_tag_cloud">
                                                    <div class="widget-inner">
                                                        ...
                                                        <div class="tagcloud"><a href="<?php echo e(route('conge.create')); ?>" class="tag-link-0">Annoncer une Absence</a><a href="<?php echo e(route('eleve.create')); ?>" class="tag-link-1">Kids</a><a href="#" class="tag-link-2">Gaming</a><a href="#" class="tag-link-3">Goods</a><a href="#" class="tag-link-4">Costume</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </li>
